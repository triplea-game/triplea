...
class JMenuItemCheckBoxBuilderTest {
  ...
  void verifyTitle() {
    final var checkBoxMenuItem =
        new JMenuItemCheckBoxBuilder(TITLE, 'a').actionListener(e -> {}).build();
  ...
  @Test
  void selected() {
    var checkBoxMenuItem = new JMenuItemCheckBoxBuilder(TITLE, 'a').actionListener(e -> {}).build();

    assertThat(checkBoxMenuItem.isSelected(), is(false));

    checkBoxMenuItem =
        new JMenuItemCheckBoxBuilder(TITLE, 'a').actionListener(e -> {}).selected(true).build();
  ...
  final class VerifyActionHandlingTest {
    ...
    void addActionListener() {
      ...
      checkBoxMenuItem =
          new JMenuItemCheckBoxBuilder(TITLE, 'a')
