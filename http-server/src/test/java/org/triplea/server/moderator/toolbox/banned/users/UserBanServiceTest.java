...
class UserBanServiceTest {
  ...
  void getBannedUsers() {
    ...
    assertThat(result.get(0).getHashedMac(), is(BANNED_USER_DAO_DATA_1.getSystemId()));
    ...
    assertThat(result.get(1).getHashedMac(), is(BANNED_USER_DAO_DATA_2.getSystemId()));
