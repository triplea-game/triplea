 ...
 * use key is a value that we can give to a moderator, or a moderator can generate for themselves,
 * and because it is only valid for one use it's okay if it's compromised by email it to yourself or
 * if others know it. Once a single-use key is registered, or used, then a new key is created which
 * then should be kept secure.
 */
@Builder
