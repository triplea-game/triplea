 ...
 * thresholds ({@code -1} disables each); {@code keepOneAttackingLandUnit} is carried for interface
...
public record BattleOptions(
  ...
  /** Defaults the retreat thresholds to disabled and keep-one-land to off. */
  public BattleOptions(
      final boolean retreatWhenOnlyAirLeft,
      final List<UnitTypeId> attackerOol,
      final List<UnitTypeId> defenderOol) {
    this(retreatWhenOnlyAirLeft, attackerOol, defenderOol, -1, -1, false);
  }
}
