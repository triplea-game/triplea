...
final class IpFinderTest {
  ...
  // 192.168.2.1
  private static final InetAddress INET4_SITE_LOCAL_ADDRESS = inetAddressOf(new byte[] {
      (byte) 0xC0, (byte) 0xA8, (byte) 0x02, (byte) 0x01
  });

  // 169.254.2.1
  private static final InetAddress INET4_LINK_LOCAL_ADDRESS = inetAddressOf(new byte[] {
      (byte) 0xA9, (byte) 0xFE, (byte) 0x02, (byte) 0x01
  });

  // 2607:f8b0:4008:80c::2004
  private static final InetAddress INET6_PUBLIC_ADDRESS = inetAddressOf(new byte[] {
      (byte) 0x26, (byte) 0x07, (byte) 0xF8, (byte) 0xB0, (byte) 0x40, (byte) 0x08, (byte) 0x08, (byte) 0x0C,
      (byte) 0x00, (byte) 0x00, (byte) 0x00, (byte) 0x00, (byte) 0x00, (byte) 0x00, (byte) 0x20, (byte) 0x04
  });

  // fec0::1ff:fe23:4567:890a
  private static final InetAddress INET6_SITE_LOCAL_ADDRESS = inetAddressOf(new byte[] {
      (byte) 0xFE, (byte) 0xC0, (byte) 0x00, (byte) 0x00, (byte) 0x00, (byte) 0x00, (byte) 0x00, (byte) 0x00,
      (byte) 0x01, (byte) 0xFF, (byte) 0xFE, (byte) 0x23, (byte) 0x45, (byte) 0x67, (byte) 0x89, (byte) 0x0A
  });

  // fe80::1ff:fe23:4567:890a
  private static final InetAddress INET6_LINK_LOCAL_ADDRESS = inetAddressOf(new byte[] {
