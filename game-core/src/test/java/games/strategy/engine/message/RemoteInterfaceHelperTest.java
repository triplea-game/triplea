...
public class RemoteInterfaceHelperTest {
  ...
  public void testSimple() {
    ...
    assertEquals(
        0, RemoteInterfaceHelper.getNumber("add", new Class<?>[] {Object.class}, Collection.class));
  ...
  public void testCorrectOverloadOrder() {
    checkMethodMatches(
        "printf",
        new Class<?>[] {Locale.class, String.class, Object[].class},
    ...
    checkMethodMatches(
        "println",
        new Class<?>[] {char.class},
        RemoteInterfaceHelper.getMethod(30, PrintStream.class));

    assertEquals(
        27, RemoteInterfaceHelper.getNumber("println", new Class<?>[] {}, PrintStream.class));
    assertEquals(
        34,
        RemoteInterfaceHelper.getNumber(
            "println", new Class<?>[] {Object.class}, PrintStream.class));
  }
