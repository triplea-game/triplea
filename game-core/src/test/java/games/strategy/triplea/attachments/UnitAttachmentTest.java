...
public class UnitAttachmentTest {
  ...
  void testSetWhenCapturedChangesInto_invalidLength() {
    ...
    assertThrows(GameParseException.class, () -> attachment.setWhenCapturedChangesInto("a:b:c:d:e:f"));
    assertThrows(GameParseException.class, () -> attachment.setWhenCapturedChangesInto("a:b:c:d:e:f:g:h"));
  }
  ...
  void testSetWhenCapturedChangesInto_invalidArgs() {
    ...
    assertThrows(GameParseException.class, () -> attachment.setWhenCapturedChangesInto("q:w:e:r:t"));
    assertThrows(GameParseException.class, () -> attachment.setWhenCapturedChangesInto("q:w:e:r:t:z:u"));
  }
  ...
  void testSetWhenCapturedChangesInto() throws Exception {
    ...
    attachment.setWhenCapturedChangesInto(concatWithColon(from, to, falseString,
        unit1String, String.valueOf(random2), unit2String, String.valueOf(random3)));
