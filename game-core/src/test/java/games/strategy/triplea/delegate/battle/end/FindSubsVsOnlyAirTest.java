...
class FindSubsVsOnlyAirTest {
  ...
  void allEnemyUnitsAreAir() {
    final List<Unit> friendlyUnits = GameDataTestUtil.submarine(GLOBAL_1940_GAME_DATA).create(1, BRITISH);
    final List<Unit> enemyUnits = GameDataTestUtil.fighter(GLOBAL_1940_GAME_DATA).create(1, GERMANS);

    final List<Unit> subs = FindSubsVsOnlyAir.builder()
