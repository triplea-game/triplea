...
public class MustFightBattleTest extends AbstractDelegateTestCase {
  ...
  public void testFightWithIsSuicideOnHit() throws Exception {
    ...
    final MustFightBattle battle =
        (MustFightBattle)
            AbstractMoveDelegate.getBattleTracker(twwGameData).getPendingBattle(sz40, false, null);
  ...
  public void testFightWithBothZeroStrength() throws Exception {
    ...
    final MustFightBattle battle =
        (MustFightBattle)
            AbstractMoveDelegate.getBattleTracker(twwGameData)
                .getPendingBattle(celebes, false, null);
