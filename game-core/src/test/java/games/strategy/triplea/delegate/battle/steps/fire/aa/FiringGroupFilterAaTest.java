...
class FiringGroupFilterAaTest {
  ...
  @Test
  void basicFiringGroupWithWaitingToDieUnits() {
    final Unit targetUnit = givenAnyUnit();
    final Unit fireUnit = givenUnitIsCombatAa(Set.of(targetUnit.getType()), attacker, OFFENSE);
    when(fireUnit.getOwner()).thenReturn(attacker);
  ...
  @Test
  void firingGroupIgnoresOtherUnits() {
    final Unit targetUnit = givenAnyUnit();
    final Unit fireUnit = givenUnitIsCombatAa(Set.of(targetUnit.getType()), attacker, OFFENSE);
    when(fireUnit.getOwner()).thenReturn(attacker);
  ...
  @Test
  void firingGroupFindsMultipleTargetsAa() {
    final Unit targetUnit = givenAnyUnit();
  ...
  @Test
  void separateFiringGroupByAaType() {
    final Unit targetUnit = givenAnyUnit();
    final Unit fireUnit =
  ...
  @Test
  void separateFiringGroupByAaTypeWithCommonTarget() {
