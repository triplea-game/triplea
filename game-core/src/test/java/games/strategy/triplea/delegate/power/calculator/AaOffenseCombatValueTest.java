...
class AaOffenseCombatValueTest {

  @Nested
  class AaOffenseRollTest {
    ...
    void calculatesValue() throws GameParseException {
      ...
      final AaOffenseCombatValue.AaOffenseRoll roll =
          new AaOffenseCombatValue.AaOffenseRoll(friendlySupport, enemySupport);
      assertThat(
  ...
  class AaOffenseStrengthTest {
    ...
    void calculatesValue() throws GameParseException {
      ...
      unitType.addAttachment(UNIT_ATTACHMENT_NAME, unitAttachment);
      final Unit unit = unitType.create(1, player, true).get(0);
      unit.getUnitAttachment().setOffensiveAttackAa(3);
