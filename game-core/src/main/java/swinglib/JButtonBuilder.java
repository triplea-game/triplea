...
public class JButtonBuilder {
  ...
  /**
   * Sets the name of the component used internally by swing, can be used later for programmatic
   * lookup of components (notably useful in test context).
   */
   ...
   *
   * @param clickAction The action listener to invoke when the button is clicked, this listener will
   *     be evaluated and attached to the button when the button is constructed (ie: {@code #build}.
   */
