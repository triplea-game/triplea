...
/**
 * Composition of a text field and an 'attached' button that acts on the field value. For example,
 * useful for input fields that have 'submit' button next to it. <br>
 * Example usage:
 *
 * <pre>
 * <code>
...
public final class JTextFieldButtonAttachmentBuilder {
  ...
  /**
   * When not null will cause builder to create a flow layout field + button, where the text value
   * of the field will be set to the button when it is clicked.
   */
  ...
  /**
   * Adds a JButton component with title and action that will be fired when the button is clicked.
   * Input of the consumer function is the value of the associated JTextField.
   */
  public JTextFieldButtonAttachmentBuilder withButton(
      final String buttonText, final Consumer<String> buttonAction) {
