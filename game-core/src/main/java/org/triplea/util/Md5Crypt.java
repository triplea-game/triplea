...
public final class Md5Crypt {
   ...
   * @return {@code true} if the specified value is a legal MD5-crypt hashed value; otherwise {@code
   *     false}.
   */
   ...
   *
   * @return The returned value may not be a legal MD5-crypt hashed value if either {@code salt} or
   *     {@code hash} are illegal and should be validated using {@link #isLegalHashedValue(String)}.
   */
