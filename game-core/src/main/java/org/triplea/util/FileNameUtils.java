...
public final class FileNameUtils {
  ...
  /**
   * Removes all illegal characters from the specified file name. Illegal file name characters include:
   *
   * <pre>
   * / \b \n \r \t \0 \f ` ? * \ < > | " ' : . , ^ [ ] = + ;
   * </pre>
  ...
  /**
   * Replaces all illegal characters in the specified file name with the specified replacement character. Illegal file
   ...
   *
   * @return The file name with all illegal characters replaced with the specified replacement character.
   */
