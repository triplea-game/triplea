...
/**
 * Used to create and show an error report window which users can use to add bug report information
 * and upload directly to TripleA servers.
 */
public final class ReportWindowController {
  ...
  public static void showWindow(final Component parent, final LogRecord logRecord) {
    final JFrame frame = new ErrorReportWindow(reportHandler).buildWindow(parent, logRecord);
