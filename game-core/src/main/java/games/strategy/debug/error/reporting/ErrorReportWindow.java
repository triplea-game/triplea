...
/**
 * This is primarily a layout class that shows a form for entering bug report information, and has
 * buttons to preview, cancel, or upload the bug report.
 */
...
class ErrorReportWindow {
  ...
  JFrame buildWindow(@Nullable final Component parent, @Nullable final LogRecord logRecord) {
    ...
    final Supplier<UserErrorReport> guiReader =
        () ->
        ...
        JPanelBuilder.builder()
            ...
            .addNorth(
                JPanelBuilder.builder()
                    .borderEmpty(3)
                    .borderLayout()
                    .addWest(JPanelBuilder.builder().borderEmpty(3).addLabel("Subject:").build())
            ...
            .addSouth(
                JPanelBuilder.builder()
                    ...
                    .add(
                        errorReportComponents.newSubmitButton(
                            frame,
                    ...
                    .add(
                        errorReportComponents.newPreviewButton(
                            frame,
                            ErrorReportComponents.FormHandler.builder()
                                .guiDataHandler(
                                    (parentFrame, data) ->
                                        new PreviewWindow()
                                            .build(parentFrame, data)
                                            .setVisible(true))
                                .guiReader(guiReader)
                                .build()))
