...
final class ViewMenu extends JMenu {
    ...
    showMapDetails.addActionListener(
        e -> {
          ...
          new Thread(
                  ...
                  "Triplea : Show map details thread")
              .start();
        });
    add(showMapDetails);
  }
    ...
    showMapBlends.addActionListener(
        e -> {
          ...
          new Thread(
                  ...
                  "Triplea : Show map Blends thread")
              .start();
        });
    add(showMapBlends);
  }
  ...
  private void addDrawTerritoryBordersAgain() {
    ...
    drawBordersMenu.addMenuListener(
        new MenuListener() {
          @Override
          public void menuSelected(final MenuEvent e) {
            final IDrawable.OptionalExtraBorderLevel current =
                uiContext.getDrawTerritoryBordersAgain();
    ...
    noneButton.addActionListener(
        e -> {
          if (noneButton.isSelected()
              && uiContext.getDrawTerritoryBordersAgain()
                  != IDrawable.OptionalExtraBorderLevel.LOW) {
    ...
    mediumButton.addActionListener(
        e -> {
          if (mediumButton.isSelected()
              && uiContext.getDrawTerritoryBordersAgain()
                  != IDrawable.OptionalExtraBorderLevel.MEDIUM) {
    ...
    highButton.addActionListener(
        e -> {
          if (highButton.isSelected()
              && uiContext.getDrawTerritoryBordersAgain()
                  != IDrawable.OptionalExtraBorderLevel.HIGH) {
