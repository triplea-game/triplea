 ...
 *
 * <p>NetworkData annotated classes do not have a method constraints, they are not necessarily called
 * by reflection or RMI, so we just need to be sure these classes can be serialized and deserialized
