...
/** Build the steps for the fire round (roll dice, select casualties, and remove casualties) */
@UtilityClass
public class FireStepsBuilder {

  @Builder
  public static class Parameters {
    @NonNull final BattleState battleState;
    @NonNull final BattleActions battleActions;
    @NonNull final FiringGroupFilter firingGroupFilter;
  ...
  public static List<BattleStep> buildSteps(final Parameters parameters) {
    ...
    final List<FiringGroup> firingGroups =
        new ArrayList<>(parameters.firingGroupFilter.apply(parameters.battleState));
    firingGroups.sort(
