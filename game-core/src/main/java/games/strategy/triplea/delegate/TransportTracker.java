...
public class TransportTracker {
  ...
  // false, in order to
  // populate the error message. However, we only need to call this method to determine why we can't
  // unload an
  // additional unit. Since transports only hold up to two units, we only need to return one
  // territory, not multiple
  // territories.
