 ...
 * implement this class, so that conditions can be tested for independently and recursively.
 */
public interface ICondition extends IAttachment {
   ...
   * a class that implements ICondition.
   */
   ...
   * this ICondition, as well as invert, conditionType, and in the case of RulesAttachments it also takes into account
   * all the different rules that must be tested for, like alliedOwnershipTerritories, unitPresence, etc etc.
