...
public interface ITripleAPlayer extends IRemotePlayer {
  ...
  Unit whatShouldBomberBomb(
      Territory territory, final Collection<Unit> potentialTargets, final Collection<Unit> bombers);
  ...
  Territory selectTerritoryForAirToLand(
      Collection<Territory> candidates, final Territory currentTerritory, String unitMessage);
