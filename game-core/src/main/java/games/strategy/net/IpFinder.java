 ...
 * On most systems the IP address it uses for internet communication will NOT be
 ...
 * and IP masquerading set properly. TripleA will be bound to their local address
...
public final class IpFinder {
   ...
   * gateway running java off a telnet session will result in a null network interface (patched below).
   *
