...
public @interface AutoSave {
  ...
  /**
   * Indicates we should auto save after the step starts. Useful for the EndTurnDelegate in PBEM/PBF
   * which allows the autosave before the "Done" button is clicked. Still a problem if the "User
   * Report" is on though - doesn't save until "OK" is clicked.
   */
