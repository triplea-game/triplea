 ...
 *
 * <p>Normally delegates should not catch this, but let it propogate.
 *
 * <p>Displays and players should handle this as it may be thrown by delegates remotes if a method
 * is executed after the game is finished.
 */
