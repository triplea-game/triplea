...
class ModeratorsTabModel {
  @VisibleForTesting
  static final List<String> HEADERS = Arrays.asList(
      "Name", "Last Login");

  @VisibleForTesting
  static final List<String> SUPER_MOD_HEADERS = Arrays.asList(
      "Name", "Last Login", "Generate API-Key", "Remove Mod", "Add Super-Mod");

  @VisibleForTesting
  static final String GENERATE_API_KEY_BUTTON_TEXT = "Generate API-Key";
  @VisibleForTesting
  static final String REMOVE_MOD_BUTTON_TEXT = "Remove Mod";
  @VisibleForTesting
  static final String ADD_SUPER_MOD_BUTTON = "Add Super-Mod";

  private final ToolboxModeratorManagementClient toolboxModeratorManagementClient;

  @Getter
  private final boolean isSuperMod;
  ...
  ModeratorsTabModel(
    ...
    isSuperMod =
        toolboxModeratorManagementClient.isCurrentUserSuperMod();
  }
  ...
  List<List<String>> fetchTableData() {
    return toolboxModeratorManagementClient
        .fetchModeratorList()
        .stream()
        .map(modInfo -> isSuperMod
            ? Arrays.asList(
                modInfo.getName(),
