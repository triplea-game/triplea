...
/**
 * This class initiates the flow of showing the moderator toolbox. Based on if an API KEY is stored in client
 * settings, we'll show the 'enter password' dialog to 'unlock' that key or we'll show the 'enter api key'
 * window for user to enter a new API key and create password.
 */
