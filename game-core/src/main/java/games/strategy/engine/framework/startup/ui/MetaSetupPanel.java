...
public class MetaSetupPanel extends SetupPanel {
  ...
  private void setupListeners() {
    ...
    hostGame.addActionListener(
        e -> new Thread(() -> model.showServer(MetaSetupPanel.this)).start());
    connectToHostedGame.addActionListener(
        e -> new Thread(() -> model.showClient(MetaSetupPanel.this)).start());
