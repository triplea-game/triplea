          ...
          helpMessage.setText(
              viewModel.getForumSelection().equals(NodeBbForumPoster.TRIPLEA_FORUM_DISPLAY_NAME)
                  ? "<html><p style='width: 400px;'>"
                      ...
                      + "Put your login and password for the forums.triplea-game.org forum into the "
                      + "login and password fields<br/>"
                      + "Click the Test Post button, to check that TripleA can reply to your forum "
                      + "post<br/>"
                      + "Note: Your forums.triplea-game.org login and password are not stored as part "
                  ...
                  : "<html><p style='width: 400px;'>"
                      ...
                      + "Put your login and password for the AxisAndAllies.org forum into the login "
                      + "and password fields<br/>"
                      + "Click the Test Post button, to check that TripleA can reply to your forum "
                      + "post<br/>"
                      + "Note: Your AxisAndAllies.org login and password are not stored as part of "
