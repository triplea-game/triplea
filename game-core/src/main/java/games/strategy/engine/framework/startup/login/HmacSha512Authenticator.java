...
final class HmacSha512Authenticator {
  ...
  static Map<String, String> newChallenge() {
    // This length is relatively large for a nonce simply because we do not currently expire nonces
    // after they have been
    // issued. If this were done, and a short nonce lifetime was used, we could probably get away
    // with 8 bytes of random
