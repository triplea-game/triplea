 ...
 * situations where you want the "end" to not be null. If the Route only has a start, it will return the start when you
 * call .end(), and it will return a length of 1 if the length is really zero.
 */
public class RouteScripted extends Route {
   ...
   * status or duplicating a zillion lines of code. The End will return the Start, and the Length will be 1.
   */
