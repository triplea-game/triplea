...
/**
 * Used for both IGamePlayer (used by the server, etc.) and specific game players such as
 * ITripleaPlayer and IGridGamePlayer (used by delegates for communication, etc.).
 */
