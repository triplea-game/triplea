...
/**
 * A marker interface, used to indicate that the interface can be used by IChannelMessenger.
 * All arguments to all methods of an IChannelSubscriber must be serializable, since the methods
