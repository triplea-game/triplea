...
public class ImageScrollerLargeView extends JComponent {
  ...
  public ImageScrollerLargeView(
      final Dimension dimension, final ImageScrollModel model, final int tileSize) {
   ...
   * Sets the view scale.
   *
   * @param value The new scale value. Constrained to the bounds of no less than 0.15 and no greater
   *     than 1. If out of bounds the nearest boundary value is used.
   */
   ...
   * {@code 1 / tileSize}. This ensures that a scaled tile will always have an integer width and
   * height.
   */
  @VisibleForTesting
