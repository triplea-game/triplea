...
/**
 * Return data when querying for a users API key. Note we return pretty limited information to avoid
 * leaking keys, we return a public id that can be referenced for deleting the key.
 */
@Builder
@AllArgsConstructor
@NoArgsConstructor
