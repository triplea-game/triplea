...
/**
 * Return data when querying about user bans. The public ban id is for public reference, this is a value
 * we can show to banned users so they can report which ban is impacting them. With that information
 * we have the ability to remove the ban without needing to ask them for mac or IP.
 */
@Builder
@AllArgsConstructor
@NoArgsConstructor
...
public class UserBanDaoData {
  ...
  public static RowMapper<UserBanDaoData> buildResultMapper() {
    return (rs, ctx) -> UserBanDaoData.builder()
