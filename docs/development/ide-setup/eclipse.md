...
##  Plugins:
  ...
  - ***Lombok***
    1. Download [jar file](https://projectlombok.org/downloads/lombok.jar) and execute it: `java -jar lombok.jar`
       ...
       - Version to use: Same version as Gradle (see `lombok` configuration in the top-level [Gradle buildscript](https://github.com/triplea-game/triplea/blob/main/build.gradle.kts))
...
1. *Project > Java Code Style > Formatter*
   1. Import profile, select the Triplea formatter file: [triplea/.build/eclipse/triplea-eclipse-java-google-style.xml
     ](https://github.com/triplea-game/triplea/blob/main/.build/eclipse/triplea-eclipse-java-google-style.xml)
...
1. Select the Triplea cleanup file: [triplea/.build/eclipse/triplea_java_eclipse_cleanup.xml
   ](https://github.com/triplea-game/triplea/blob/main/.build/eclipse/triplea_java_eclipse_cleanup.xml)
...
](https://github.com/triplea-game/triplea/blob/main/.build/eclipse/triplea.importorder)
