...
<br>
If you need to know how the inside of the folder called "map" should look, consult [this tutorial](https://github.com/triplea-game/triplea/blob/main/docs/map-making/tutorial/creating-custom-map-xml.md)
