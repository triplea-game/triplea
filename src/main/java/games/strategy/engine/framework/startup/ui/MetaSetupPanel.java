...
import org.triplea.client.launch.LaunchScreen;
...
public class MetaSetupPanel extends SetupPanel {
  ...
  private void layoutComponents() {
    ...
    if (ClientSetting.SHOW_BETA_FEATURES.booleanValue()) {
      final JButton newUI = JButtonBuilder.builder()
          .title("Launch new UI")
          .actionListener(LaunchScreen::show)
          .build();
      add(newUI, new GridBagConstraints(0, 13, 1, 1, 0, 0, GridBagConstraints.CENTER, GridBagConstraints.NONE,
          new Insets(10, 0, 0, 0), 0, 0));
    }
  }
