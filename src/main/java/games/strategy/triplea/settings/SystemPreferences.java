...
//   * </p>
//   */
//  public static void put(ClientPreference key, String value) {
//    putNoFlush(key, value);
//    flush();
//  }
//
//  /**
//   * @see SystemPreferences#put(ClientPreference, String).
//   */
//  public static void put(ClientPreference key, boolean value) {
//    put(key, String.valueOf(value));
//  }
//
//  public static void put(ClientPreference tripleaServerObserverJoinWaitTime, int wait) {
...
//   */
//  private static void putNoFlush(ClientPreference key, String value) {
...
//   */
//  public static String get(ClientPreference key, String defaultValue) {
//    return getPrefs().get(key.name(), defaultValue);
//  }
//
//
//  /**
//   * @see SystemPreferences#get(ClientPreference, String).
//   */
//  public static boolean get(ClientPreference key, boolean defaultValue) {
...
//   * @see SystemPreferences#get(ClientPreference, String).
//   */
//  public static int get(ClientPreference key, int defaultValue) {
