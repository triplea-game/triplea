...
public class NPuzzleMapPanel extends GridMapPanel {
  ...
  public NPuzzleMapPanel(final GameData data, final GridMapData mapData, final GridGameFrame parentGridGameFrame,
  ...
  public void setBackgroundImage(final File file) {
    if (file != null) {
      try {
        ...
        m_backgroundImage = new BufferedImage(((int) m_mapData.getMapDimensions().getWidth()),
            ((int) m_mapData.getMapDimensions().getHeight()), bigimage.getType());
