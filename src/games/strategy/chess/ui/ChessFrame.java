...
public class ChessFrame extends MainGameFrame
{
	...
	public ChessFrame(final IGame game, final Set<IGamePlayer> players)
	{
		...
		// The MapData holds info for the map, including the dimensions (x_dim and y_dim)
		final MapData mapData = new MapData(m_data, x_dim, y_dim);
		...
		this.setJMenuBar(new ChessMenu(this));
	...
	{
		m_mapPanel.performPlay(start, end, unit, captured);
	}
