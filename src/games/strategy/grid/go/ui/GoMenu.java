  ...
  protected void addHowToPlayHelpMenu(final JMenu parentMenu) {
    parentMenu.add(new AbstractAction("How to play...") {
      ...
      public void actionPerformed(final ActionEvent e) {
        ...
        final String hints =
            "<p><b>Go</b> (Weiqi / Igo / Baduk)" + "<br />http://en.wikipedia.org/wiki/Rules_of_Go</p> "
                + "<br /><br /><b>How To Pass Your Turn</b> " + "<br />Press 'P' on your keyboard to pass your turn. "
                + "<br />If both players pass in a row, the game ends. " + "<br /><br /><b>How To Place Pieces</b> "
                ...
                + "<br /><br /><b>Simple Rules</b> " + "<br />1. The board starts empty. "
                ...
                + "<br />9. The player with more territory wins. " + "<br /><br /><b>Capturing</b> "
                ...
                + "<br /><br /><b>End of Game</b>" + "<br />The game ends after both players consecutively pass. "
