...
public interface ISound extends IChannelSubscribor {
  ...
  /**
   * You will want to call this from things that the server only runs (like delegates), and not call this from user interface elements
   ...
   *        The machines controlling these PlayerID's who we do not want to hear this sound. If the machine controls players in both
