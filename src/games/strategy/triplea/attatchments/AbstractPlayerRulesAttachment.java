...
public abstract class AbstractPlayerRulesAttachment extends AbstractRulesAttachment {
  ...
  protected boolean m_unlimitedProduction = false; // turns of the warning to the player when they produce more than
                                                   // they can place
  ...
  protected IntegerMap<UnitType> m_productionPerXTerritories = new IntegerMap<UnitType>(); // automatically produces 1
                                                                                           // unit of a certain
                                                                                           // type per every X
                                                                                           // territories owned
  protected int m_placementPerTerritory = -1; // stops the user from placing units in any territory that already
