...
public interface ICondition extends IAttachment {
  ...
  /**
   * Tests if the attachment, as a whole, is satisfied. This includes and takes account of all conditions that make up this ICondition, as
  ...
  /**
   * HashMap<ICondition, Boolean> testedConditions must be filled with completed tests of all conditions already, or this will give you
   * errors.
   *
   * @param testedConditions
   * @param aBridge
