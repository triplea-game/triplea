...
public class OCUnit {
  ...
  public static OCUnit newSub() {
    OCUnit subUnit = null;
    subUnit = new OCUnit(StandardUnits.SubCost, StandardUnits.SubAttack, StandardUnits.SubDefend, StandardUnits.SubMove,
        StandardUnits.SubName, true, OCUnit.SEAUNIT, false, false);
    return subUnit;
  }

  public static OCUnit newTrn() {
    OCUnit trnUnit = null;
    trnUnit = new OCUnit(StandardUnits.TrnCost, StandardUnits.TrnAttack, StandardUnits.TrnDefend, StandardUnits.TrnMove,
        StandardUnits.TrnName, false, OCUnit.SEAUNIT, false, true);
    return trnUnit;
  }
  ...
  public static OCUnit newArm() {
    OCUnit armUnit = null;
    armUnit = new OCUnit(StandardUnits.ArmCost, StandardUnits.ArmAttack, StandardUnits.ArmDefend, StandardUnits.ArmMove,
        StandardUnits.ArmName, false, OCUnit.LANDUNIT, false, true);
    return armUnit;
  }

  public static OCUnit newInf() {
    OCUnit infUnit = null;
    infUnit = new OCUnit(StandardUnits.InfCost, StandardUnits.InfAttack, StandardUnits.InfDefend, StandardUnits.InfMove,
        StandardUnits.InfName, false, OCUnit.LANDUNIT, false, true);
    return infUnit;
  }
  ...
  public static OCUnit newFighter() {
    OCUnit fighter = null;
    fighter = new OCUnit(StandardUnits.FtrCost, StandardUnits.FtrAttack, StandardUnits.FtrDefend, StandardUnits.FtrMove,
        StandardUnits.FtrName, false, OCUnit.AIRUNIT, false, true);
    return fighter;
  }
