...
public interface Constants {
  ...
  public static final String UNIT_ATTACHMENT_NAME = "unitAttachment";
  public static final String INF_ATTACHMENT_NAME = "infAttachment";
  public static final String TECH_ATTACHMENT_NAME = "techAttachment";
  public static final String TECH_ABILITY_ATTACHMENT_NAME = "techAbilityAttachment";
  public static final String RESOURCE_ATTACHMENT_NAME = "resourceAttachment";
  public static final String TERRITORY_ATTACHMENT_NAME = "territoryAttachment";
  public static final String RULES_ATTACHMENT_NAME = "rulesAttachment";
  ...
  public static final String PLAYER_ATTACHMENT_NAME = "playerAttachment";
  public static final String RELATIONSHIPTYPE_ATTACHMENT_NAME = "relationshipTypeAttachment";
  public static final String CANAL_ATTACHMENT_PREFIX = "canalAttachment";
