        ...
        try {
          ...
          if (status == 302) {
            ...
            if (refreshHeader != null) {
              ...
              final String value = refreshHeader.getValue(); // refresh: 0;
                                                             // URL=http://...topic=26114.new%3bspam=true#new
              final Pattern p =
          ...
          post.releaseConnection();
          // Commented out log out call since it was causing all of a user's sessions to be logged out and doesn't
          // appear to be needed
          // final GetMethod logout = new GetMethod("http://www.axisandallies.org/forums/index.php?action=logout;sesc="
          // + sc);
          // try
          // {
