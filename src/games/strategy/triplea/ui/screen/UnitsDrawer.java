...
public class UnitsDrawer implements IDrawable {
  ...
  public void draw(final Rectangle bounds, final GameData data, final Graphics2D graphics, final MapData mapData,
     ...
     * {
     * // kev, why are we doing a for loop here? each unit that needs to be drawn individually will be drawn if sorted
     * properly, at least
     * that was my understanding
     * final Collection<Unit> units =
     * Match.getMatches(data.getMap().getTerritory(m_territoryName).getUnits().getUnits(),
