...
public class BattlePanel extends ActionPanel
{
	...
	{
		setStep(message);
		JOptionPane.showMessageDialog(getRootPane(), message.getMessage(), "Message", JOptionPane.PLAIN_MESSAGE);
		return null;
	}
	...
	public RetreatMessage getRetreat(RetreatQueryMessage rqm)
	{
		...
		int choice = JOptionPane.showConfirmDialog(getTopLevelAncestor(), message, "", JOptionPane.OK_CANCEL_OPTION);
