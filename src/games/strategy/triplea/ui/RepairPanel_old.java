...
//public class RepairPanel extends PurchasePanel
{
    ...
    *//** Creates new PurchasePanel *//*
    ...
    {
        return new RepairPanel(context).show(id, parent, data, bid, initialPurchase);
    }
    *//**
     * Shows the production panel, and returns a map of selected rules.
     *//*
    public IntegerMap<Rule> show(PlayerID id, JFrame parent, GameData data, boolean bid, IntegerMap<RepairRule> m_repair)
    {
        if (!(parent == m_owner))
            m_dialog = null;
