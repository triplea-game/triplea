...
public class UserActionPanel extends ActionPanel {
  ...
  public UserActionAttachment waitForUserActionAction(final boolean firstRun,
    ...
    m_validUserActions = new ArrayList<UserActionAttachment>(iUserActionsDelegate.getValidActions()); // reset each
                                                                                                      // time, we need
                                                                                                      // to retest
                                                                                                      // the
                                                                                                      // conditions...
    Collections.sort(m_validUserActions, new UserActionComparator(getCurrentPlayer(), getData()));
    if (m_validUserActions.isEmpty()) // change to (m_firstRun && m_validUserActions.isEmpty()) if you want to have it
