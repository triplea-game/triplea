...
public class RepairPanel extends ActionPanel
{
	...
	private final Action DoneAction = new AbstractAction("Done")
	{
		...
		public void actionPerformed(final ActionEvent event)
		{
			...
			if (!hasPurchased)
			{
				final int rVal = JOptionPane.showConfirmDialog(JOptionPane.getFrameForComponent(RepairPanel.this), "Are you sure you dont want to repair anything?", "End Purchase",
