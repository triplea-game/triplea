 ...
 * Overriding
 *
 * Subclasses can over ride one of these methods to change the way this class works.
 * playerHasEnoughUnits(...), canProduce(...), canUnitsBePlaced(...)
 *
 * For a simpler way you can override
 * getProduction(...) which is called in the default canProduce(...) method
 *
