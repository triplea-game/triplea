...
public class LogUtils {
   ...
   * For example, the base logs in the Pro AI class have no indentation before them, but the base logs in the DoCombatMove class will have
   ...
   *
   * Second, I generally want the Fine logs to be messages that run less than 10 times each round, including almost all messages in the Pro
   * AI class,
