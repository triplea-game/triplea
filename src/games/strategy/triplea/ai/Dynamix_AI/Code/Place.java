...
public class Place {
  public static void place(final Dynamix_AI ai, final boolean bid, final IAbstractPlaceDelegate placeDelegate, final GameData data,
    ...
    if (DSettings.LoadSettings().AIC_disableAllUnitPurchasesAndPlacements) {
      ...
      final Change change = ChangeFactory.changeResourcesChange(player, GlobalCenter.GetPUResource(),
          -player.getResources().getQuantity(GlobalCenter.GetPUResource()));
                                                                                                                                      ...
                                                                                                                                      // window.
    {
      ...
      if (PUChange > 0) {
        ...
        final String message = ai.getName() + " use an RCI cheat, and increase their PUs from "
  ...
  private static boolean doPlace(final Dynamix_AI ai, Territory ter, final Collection<Unit> units, final GameData data,
      final IAbstractPlaceDelegate placer) {
