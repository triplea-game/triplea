...
public class DMatches {
  ...
  public static Match<Territory> terIsFriendlyEmptyAndWithoutEnemyNeighbors(final GameData data, final PlayerID player) {
    return new Match<Territory>() {
      ...
      public boolean match(final Territory ter) {
        ...
        if (data.getMap().getNeighbors(ter, DMatches.territoryIsOwnedByNNEnemy(data, player)).size() > 0) {
          return false;
        }
        return true;
      }
  ...
  public static Match<Territory> TerritoryHasVulnerabilityEqualToOrMoreThan(final GameData data, final PlayerID player,
      final float minVulnerability, final int runCount) {
    return new Match<Territory>() {
      @Override
      public boolean match(final Territory ter) {
  ...
  public static Match<Territory> TerritoryHasSurvivalChanceEqualToOrMoreThan(final GameData data, final PlayerID player,
      final float minSurvivalChance, final int runCount) {
    return new Match<Territory>() {
      @Override
      public boolean match(final Territory ter) {
  ...
  public static Match<Territory> territoryIsWithinXLMovesOfATerInList(final List<Territory> list, final int maxJumpDist,
      final GameData data) {
    return new Match<Territory>() {
      @Override
      public boolean match(final Territory territory) {
        for (final Territory ter : list) {
          if (DUtils.CanWeGetFromXToY_ByPassableLand(data, ter, territory)
              && DUtils.GetJumpsFromXToY_PassableLand(data, ter, territory) <= maxJumpDist) {
            return true;
          }
        }
        return false;
  ...
  public static final Match<Territory> TerritoryIsLandAndPassable =
  ...
  public static Match<Territory> territoryHasUnitsMatchingXThatCanReach(final PlayerID player, final GameData data,
  ...
  public static Match<Territory> territoryHasNNEnemyUnitsThatCanReach(final PlayerID player, final GameData data,
