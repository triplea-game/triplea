...
public class HistoryWriter implements java.io.Serializable
{
   ...
   */
  public void startNextStep(String stepName, String delegateName, PlayerID player)
  {
      if(isCurrentEvent())
          closeCurrent();
      ...
      Step currentStep = new Step(stepName, delegateName, player, m_history.getChanges().size());
