...
public interface IAttachment extends Serializable {
   ...
   * static final String PROPERTY_PlayerAttachment_TAKE_UNIT_CONTROL = "takeUnitControl"; // kept for backwards compatibility to avoid
   ...
   * static final String PROPERTY_UnitAttachment_IS_MECHANIZED = "isMechanized"; // kept for backwards compatibility to avoid giving users
   * java errors. does nothing.
   * static final String PROPERTY_UnitAttachment_IS_PARATROOP = "isParatroop"; // kept for backwards compatibility to avoid giving users
   * java errors. does nothing.
