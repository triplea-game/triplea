...
public interface IAttachment extends Serializable {
   ...
   * static final String PROPERTY_PlayerAttachment_TAKE_UNIT_CONTROL = "takeUnitControl"; // kept for backwards
   * compatibility to avoid
   * giving users java errors. does nothing.
   ...
   * // TerritoryAttachment
   * // FYI: "originalOwner" does not belong in IAttachment as the user can not set it as a territory attachment
   * property
   ...
   * static final String PROPERTY_UnitAttachment_CAN_NOT_MOVE_DURING_COMBAT_MOVE = "canNotMoveDuringCombatMove"; // just
   * added this
   * static final String PROPERTY_UnitAttachment_CAN_ONLY_BE_PLACED_IN_TERRITORY_VALUED_AT_X =
   ...
   * static final String PROPERTY_UnitAttachment_CONSTRUCTIONS_PER_TERR_PER_TYPE_PER_TURN =
   ...
   * static final String PROPERTY_UnitAttachment_IS_MECHANIZED = "isMechanized"; // kept for backwards compatibility to
   * avoid giving users
   * java errors. does nothing.
   * static final String PROPERTY_UnitAttachment_IS_PARATROOP = "isParatroop"; // kept for backwards compatibility to
   * avoid giving users
   * java errors. does nothing.
   ...
   * // FYI: "attemptsLeftThisTurn" does not belong in IAttachment as the user can not set it as a political action
   * attachment property
   ...
   * static final String PROPERTY_RelationshipTypeAttachment_CAN_LAND_AIR_UNITS_ON_OWNED_LAND =
   * "canLandAirUnitsOnOwnedLand";
   * static final String PROPERTY_RelationshipTypeAttachment_CAN_MOVE_AIR_UNITS_OVER_OWNED_LAND =
   * "canMoveAirUnitsOverOwnedLand";
   * static final String PROPERTY_RelationshipTypeAttachment_CAN_MOVE_LAND_UNITS_OVER_OWNED_LAND =
   * "canMoveLandUnitsOverOwnedLand";
   * static final String PROPERTY_RelationshipTypeAttachment_CAN_TAKE_OVER_OWNED_TERRITORY =
   * "canTakeOverOwnedTerritory";
   * static final String PROPERTY_RelationshipTypeAttachment_GIVES_BACK_ORIGINAL_TERRITORIES =
   ...
   * static final String PROPERTY_RelationshipTypeAttachment_CAN_MOVE_INTO_DURING_COMBAT_MOVE =
   * "canMoveIntoDuringCombatMove"; // just added
   * this 2
   * static final String PROPERTY_RelationshipTypeAttachment_CAN_MOVE_THROUGH_CANALS = "canMoveThroughCanals"; // just
   * added this 2
   * // AbstractPlayerRulesAttachment
   * static final String PROPERTY_AbstractPlayerRulesAttachment_DOMINATING_FIRST_ROUND_ATTACK =
   ...
   * static final String PROPERTY_AbstractPlayerRulesAttachment_MOVEMENT_RESTRICTION_TERRITORIES =
   ...
   * static final String PROPERTY_AbstractPlayerRulesAttachment_NEGATE_DOMINATING_FIRST_ROUND_ATTACK =
   ...
   * static final String PROPERTY_AbstractPlayerRulesAttachment_PLACEMENT_CAPTURED_TERRITORY =
   * "placementCapturedTerritory";
   * static final String PROPERTY_AbstractPlayerRulesAttachment_PLACEMENT_IN_CAPITAL_RESTRICTED =
   ...
   * static final String PROPERTY_AbstractPlayerRulesAttachment_PRODUCTION_PER_X_TERRITORIES =
   ...
   * // FYI: "countEach", "eachMultiple", and "territoryCount" do not belong in IAttachment as the user can not set it
   * as a abstract rules
   * attachment property
   ...
   * // RulesAttachment
   * // FYI: "techCount" and "atWarCount" do not belong in IAttachment as the as the user can not set it as a rules
   * attachment property
   ...
   * static final String PROPERTY_RulesAttachment_ENEMY_SURFACE_EXCLUSION_TERRITORIES =
   ...
   * // FYI: "usedThisRound" does not belong in IAttachment as the as the user can not set it as a trigger attachment
   * property
   ...
   * static final String PROPERTY_TriggerAttachment_RELATIONSHIP_TYPE_ATTACHMENT_NAME =
