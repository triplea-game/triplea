...
public class BanPlayerAction extends AbstractAction
{
    ...
    public void actionPerformed(ActionEvent e)
    {
        ...
        for (INode node : m_messenger.getNodes())
        {
            ...
            {
                ClientLoginValidator.getInstance().NotifyIPBanningOfPlayer(node.getAddress().getHostAddress());
                ClientLoginValidator.getInstance().NotifyMacBanningOfPlayer(ClientLoginValidator.getInstance().GetMacAddressesOfPlayers().get(node.getName()));
