...
public class AccessLog {
  ...
  public static void successfulLogin(final String userName, final InetAddress from) {
    s_logger
        .info("LOGIN name:" + userName + " ip:" + from.getHostAddress() + " time_ms:" + System.currentTimeMillis() + " time:" + new Date());
  }

  public static void failedLogin(final String userName, final InetAddress from, final String error) {
    s_logger.info("FAILED name:" + userName + " ip:" + from.getHostAddress() + " time_ms:" + System.currentTimeMillis() + " error:" + error
        + " time:" + new Date());
  }
}
