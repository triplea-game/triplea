...
public class LobbyLoginValidator implements ILoginValidator
{
    ...
    private String verifyConnectionInternal(Map<String, String> propertiesSentToClient, Map<String, String> propertiesReadFromClient, String clientName, String clientMac, SocketAddress remoteAddress)
    {
        ...
        if(!MacFinder.isMacValid(clientMac))
        {
            return INVALID_MAC;
        }
        if(new BannedMacController().isMacBanned(clientMac))
        {
            return YOU_HAVE_BEEN_BANNED;
        }
