...
public class TripleAWarClubForumPoster extends AbstractForumPoster
{
	...
	private void login() throws Exception
	{
		...
		PostMethod post = new PostMethod("http://www.tripleawarclub.org/user.php");
	...
	public boolean postTurnSummary(String summary, final String subject)
	{
		try
		{
			...
			String url = "http://www.tripleawarclub.org/modules/newbb/reply.php?forum=" + s_forumId + "&topic_id=" + m_topicId;
			...
			try
			{
				...
				Matcher m = s_XOOPS_TOKEN_REQUEST.matcher(body);
				if (!m.matches()) {
			...
			PostMethod post = new PostMethod("http://www.tripleawarclub.org/modules/newbb/post.php");
	...
	{
		TripleAWarClubForumPoster clone = new TripleAWarClubForumPoster();
