...
public interface LobbyWatcherClient {
  ...
  @RequestLine("POST " + ServerPaths.POST_GAME_PATH)
  GamePostingResponse postGame(GamePostingRequest gamePostingRequest);

  @RequestLine("POST " + ServerPaths.UPDATE_GAME_PATH)
  ...
  @RequestLine("POST " + ServerPaths.KEEP_ALIVE_PATH)
  boolean sendKeepAlive(String gameId);

  @RequestLine("POST " + ServerPaths.REMOVE_GAME_PATH)
  void removeGame(String gameId);

  @RequestLine("POST " + ServerPaths.PLAYER_JOINED_PATH)
  ...
  @RequestLine("POST " + ServerPaths.PLAYER_LEFT_PATH)
