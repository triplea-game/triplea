...
public class ToolboxUsernameBanClient {
  public static final String REMOVE_BANNED_USER_NAME_PATH = "/moderator-toolbox/remove-username-ban";
  ...
  public static ToolboxUsernameBanClient newClient(final URI serverUri, final ApiKeyPassword apiKeyPassword) {
