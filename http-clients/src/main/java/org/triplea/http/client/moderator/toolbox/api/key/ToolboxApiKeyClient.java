...
/**
 * Http client intended for interaction with server to manage API keys. This includes view, validate,
 * create and delete.
 */
...
public class ToolboxApiKeyClient {
  ...
  public static final String GENERATE_SINGLE_USE_KEY_PATH = "/moderator-toolbox/generate-single-use-key";
  ...
  public static ToolboxApiKeyClient newClient(final URI serverUri, final ApiKeyPassword apiKeyPassword) {
