...
class ServerEventEnvelopeTest {
  ...
  void toPlayerStatusChange() {
    final ServerEventEnvelope serverEventEnvelope =
        ServerEventEnvelope.packageMessage(
            ServerEventEnvelope.ServerMessageType.STATUS_CHANGED, statusUpdate);
  ...
  private static ServerEventEnvelope toAndFromJson(final ServerEventEnvelope serverEventEnvelope) {
    final String jsonString = gson.toJson(serverEventEnvelope);
    return gson.fromJson(jsonString, ServerEventEnvelope.class);
  }
  ...
  void toPlayerLeft() {
    final ServerEventEnvelope serverEventEnvelope =
        ServerEventEnvelope.packageMessage(
            ServerEventEnvelope.ServerMessageType.PLAYER_LEFT, playerLeft);
  ...
  void toPlayerJoined() {
    final ServerEventEnvelope serverEventEnvelope =
        ServerEventEnvelope.packageMessage(
            ServerEventEnvelope.ServerMessageType.PLAYER_JOINED, playerJoined);
  ...
  void toChatMessage() {
    final ServerEventEnvelope serverEventEnvelope =
        ServerEventEnvelope.packageMessage(
            ServerEventEnvelope.ServerMessageType.CHAT_MESSAGE, chatMessage);
  ...
  void toSlapEvent() {
    final ServerEventEnvelope serverEventEnvelope =
        ServerEventEnvelope.packageMessage(
            ServerEventEnvelope.ServerMessageType.PLAYER_SLAPPED, playerSlapped);
  ...
  void toPlayerListing() {
    final ServerEventEnvelope serverEventEnvelope =
        ServerEventEnvelope.packageMessage(
            ServerEventEnvelope.ServerMessageType.PLAYER_LISTING, playerListing);
  ...
  void toErrorMessge() {
    final ServerEventEnvelope serverEventEnvelope =
        ServerEventEnvelope.packageMessage(
            ServerEventEnvelope.ServerMessageType.SERVER_ERROR, ERROR_MESSAGE);
