...
class ModeratorToolboxFeignClientTest {
  ...
  private static final String EPOCH_SECOND = "1559845434.585923000";
  private static final ModeratorEvent EVENT_1 = ModeratorEvent.builder()
      .date(Instant.ofEpochSecond(1559845434, 585923000))
  ...
  private static final String MDOERATOR_EVENT_JSON_RESPONSE =
      "[{\"date\":" + EPOCH_SECOND + ","
          + "\"moderatorName\":\"" + EVENT_1.getModeratorName() + "\","
          + "\"moderatorAction\":\"" + EVENT_1.getModeratorAction() + "\","
          + "\"actionTarget\":\"" + EVENT_1.getActionTarget() + "\"}]";
    ...
    wireMockServer.stubFor(
        WireMock.get(ModeratorToolboxClient.AUDIT_HISTORY_PATH + "?rowStart=3&rowCount=10")
            ...
            .willReturn(
                WireMock.aResponse()
                    .withStatus(200)
                    .withBody(MDOERATOR_EVENT_JSON_RESPONSE)));
