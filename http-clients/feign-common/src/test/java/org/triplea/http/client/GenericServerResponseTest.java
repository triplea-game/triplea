...
class GenericServerResponseTest {
    ...
    @Test
    void isSuccess() {
        GenericServerResponse genericServerResponseTrue = GenericServerResponse.builder().success(true).build();
        GenericServerResponse genericServerResponseFalse = GenericServerResponse.builder().success(false).build();
    ...
    @Test
    void getMessage() {
        GenericServerResponse genericServerResponse = GenericServerResponse.builder().message("test").build();
