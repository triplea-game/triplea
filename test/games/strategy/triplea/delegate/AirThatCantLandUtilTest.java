...
public class AirThatCantLandUtilTest extends TestCase {
  ...
  private static ITripleAPlayer_ren getDummyPlayer() {
    ...
    return (ITripleAPlayer_ren) Proxy.newProxyInstance(Thread.currentThread().getContextClassLoader(),
        new Class[] {ITripleAPlayer_ren.class}, handler);
  }
}
