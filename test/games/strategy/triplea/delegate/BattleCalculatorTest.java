...
public class BattleCalculatorTest extends TestCase {
  ...
  public void testAACasualtiesLowLuck() {
    ...
    final Collection<Unit> casualties = BattleCalculator.getAACasualties(false, planes, planes, defendingAA, defendingAA, roll, m_bridge,
        null, null, null, territory("Germany", data), null,
  ...
  public void testAACasualtiesLowLuckMixed() {
    ...
    final DiceRoll roll = DiceRoll.rollAA(
        Match.getMatches(planes, Matches.unitIsOfTypes(UnitAttachment.get(defendingAA.iterator().next().getType()).getTargetsAA(data))),
  ...
  public void testAACasualtiesLowLuckMixedWithChooseAACasualties() {
    ...
    final DiceRoll roll = DiceRoll.rollAA(
        ...
        defendingAA, m_bridge,
        territory("Germany", data), true);
    final Collection<Unit> casualties = BattleCalculator
        .getAACasualties(false, planes, planes, defendingAA, defendingAA, roll, m_bridge, germans(data), british(data), null,
            territory("Germany", data), null, false, null)
        .getKilled();
    assertEquals(casualties.size(), 2);
