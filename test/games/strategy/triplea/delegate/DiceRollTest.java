...
public class DiceRollTest extends TestCase
{
	...
	public void testSimple()
	{
		...
		final DiceRoll roll = DiceRoll.rollDice(infantry, true, russians, bridge, battle, "");
		assertEquals(1, roll.getHits());
		// infantry does not hit at 2 (0 based)
		bridge.setRandomSource(new ScriptedRandomSource(new int[] { 2 }));
		final DiceRoll roll2 = DiceRoll.rollDice(infantry, true, russians, bridge, battle, "");
		...
		final DiceRoll roll3 = DiceRoll.rollDice(infantry, false, russians, bridge, battle, "");
		assertEquals(1, roll3.getHits());
		// infantry attack does not hit at 1 (0 based)
		bridge.setRandomSource(new ScriptedRandomSource(new int[] { 1 }));
		final DiceRoll roll4 = DiceRoll.rollDice(infantry, false, russians, bridge, battle, "");
	...
	public void testHeavyBombers()
	{
		...
		final DiceRoll dice = DiceRoll.rollDice(bombers, false, british, testDelegateBridge, new MockBattle(m_data.getMap().getTerritory("Germany")), "");
	...
	public void testHeavyBombersDefend()
	{
		...
		final DiceRoll dice = DiceRoll.rollDice(bombers, true, british, testDelegateBridge, new MockBattle(m_data.getMap().getTerritory("Germany")), "");
