 ...
 * @version 1.0
 */
public class StrategyGameSuite extends TestCase
{
	public static Test suite()
	{
		final TestSuite suite = new TestSuite(StrategyGameSuite.class.getSimpleName());
	...
	public StrategyGameSuite(final String name)
	{
		super(name);
	}
}
