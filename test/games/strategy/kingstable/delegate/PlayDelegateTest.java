...
public class PlayDelegateTest extends DelegateTest {
   ...
   * String results = null;
   * setupTurn(black);
   * results = m_delegate.play(m_data.getMap().getTerritoryFromCoordinates(3,0),
   * m_data.getMap().getTerritoryFromCoordinates(1,0));
   * assertValid(results);
   * setupTurn(white);
   * results = m_delegate.play(m_data.getMap().getTerritoryFromCoordinates(6,4),
   * m_data.getMap().getTerritoryFromCoordinates(9,4));
   * assertValid(results);
   * setupTurn(black);
   * results = m_delegate.play(m_data.getMap().getTerritoryFromCoordinates(5,1),
   * m_data.getMap().getTerritoryFromCoordinates(10,1));
   * assertValid(results);
   * setupTurn(white);
   * results = m_delegate.play(m_data.getMap().getTerritoryFromCoordinates(5,3),
   * m_data.getMap().getTerritoryFromCoordinates(2,3));
   * assertValid(results);
   * setupTurn(black);
   * results = m_delegate.play(m_data.getMap().getTerritoryFromCoordinates(5,9),
   * m_data.getMap().getTerritoryFromCoordinates(7,9));
   * assertValid(results);
   * setupTurn(white);
   * results = m_delegate.play(m_data.getMap().getTerritoryFromCoordinates(5,4),
   * m_data.getMap().getTerritoryFromCoordinates(5,1));
   * assertValid(results);
   * setupTurn(black);
   * results = m_delegate.play(m_data.getMap().getTerritoryFromCoordinates(7,10),
   * m_data.getMap().getTerritoryFromCoordinates(8,10));
   * assertValid(results);
   * }
   ...
   * // King moves
   * setupTurn(white);
   * results = m_delegate.play(m_data.getMap().getTerritoryFromCoordinates(5,5),
   * m_data.getMap().getTerritoryFromCoordinates(5,3));
   * assertValid(results);
   * setupTurn(black);
   * results = m_delegate.play(m_data.getMap().getTerritoryFromCoordinates(10,6),
   * m_data.getMap().getTerritoryFromCoordinates(9,6));
   * assertValid(results);
   * setupTurn(white);
   * results = m_delegate.play(m_data.getMap().getTerritoryFromCoordinates(5,3),
   * m_data.getMap().getTerritoryFromCoordinates(8,3));
   * assertValid(results);
   * setupTurn(black);
   * results = m_delegate.play(m_data.getMap().getTerritoryFromCoordinates(10,7),
   * m_data.getMap().getTerritoryFromCoordinates(10,9));
   * assertValid(results);
   * setupTurn(white);
   * results = m_delegate.play(m_data.getMap().getTerritoryFromCoordinates(8,3),
   * m_data.getMap().getTerritoryFromCoordinates(8,9));
   * assertValid(results);
   * }
   ...
   * prepareForCaptures();
   * setupTurn(black);
   * String results = m_delegate.play(m_data.getMap().getTerritoryFromCoordinates(10,3),
   * m_data.getMap().getTerritoryFromCoordinates(9,3));
   * assertValid(results);
